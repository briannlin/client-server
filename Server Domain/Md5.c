...
/* Computes the message digest for a specified file.
   ...
   return.
 */
static void MDFile (filename, hash_buffer)
char *filename;
char* hash_buffer;
{
...
int checksum(char* filename1, char* filename2)
{
	char buf1[17];
	char buf2[17];
	MDFile(filename1, buf1);
	MDFile(filename2, buf2);
