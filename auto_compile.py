...
os.system('gcc "Client Domain/client.c" -o "Client Domain/client" -std=c99 -pthread')
os.system('gcc "Server Domain/server.c" -o "Server Domain/server" -std=c99 -pthread')
